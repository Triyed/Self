...
Copyright (c) 2026 [Alireza]. All Rights Reserved.

This software is the proprietary property of [Alireza]
and is protected by copyright law and international treaties.

STRICTLY PROHIBITED:
- Modification, adaptation, or creation of derivative works
- Decompilation, reverse engineering, or disassembly
- Distribution, sublicensing, or commercial use
...
async def spamer_handler(client, message):
    ...
    if str(Userid) in listadmin:
        if text == "bot":
            ...
            await message.reply_text("""🌵 راهنمای اتکر
    ...
    ❋ owner : [Alireza🧑‍💻](https://t.me/Triyed)          
            """)
    ...
    ❋ owner : [Alireza🧑‍💻](https://t.me/La_shy)          
            """)
